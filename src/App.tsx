...
const CSS = `
  * { box-sizing: border-box; }
  ...
  .login-box { max-width: 400px; margin: 80px auto; padding: 32px; border: 4px solid #751413; border-radius: 8px; background: #fff; box-shadow: 0 2px 12px rgba(0,0,0,0.1); color: #333; }
